...
<body>
    ...
    <div style="position:absolute;left:50%;margin-left:-297px;top:0px;width:595px;height:841px;border-style:outset;overflow:hidden">
        ...
        <div style="position:absolute;left:42.48px;top:122.80px" class="cls_006"><span class="cls_006">CLÁUSULA 4ª</span><span class="cls_003"> - O estagiário será acompanhado pelo(a) professor(a) orientador(a) <b>'.$nomeOrientador.'<b/>, </span><span class="cls_002"> </span><span class="cls_003">do IFSULDEMINAS,</span></div>
        <div style="position:absolute;left:42.48px;top:133.12px" class="cls_003"><span class="cls_003">campus Poços de Caldas e pelo(a) supervisor(a) <b>'.$nomeSupervisor.'<b/>, <b>'.$cargoSupervisor.'<b/></span><span> na empresa </span><b>'.$nomeEmpresa.'<b/></span></div>
        <div style="position:absolute;left:42.48px;top:144.40px" class="cls_002"><span class="cls_002">que deverão apor seus vistos nos relatórios de atividades e no relatório de aprovação do ESTAGIÁRIO.</span></div>
