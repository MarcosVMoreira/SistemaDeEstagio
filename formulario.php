...
if (!((isset($_SESSION['ra']) && $_SESSION['ra'] != "") && (isset($_SESSION['nome']) && $_SESSION['nome'] != "") && (isset($_SESSION['senha']) && $_SESSION['senha'] != ""))) {
    ...
    if($_SESSION['idEstagio'] == NULL){
        ...
        $tipoCargaHorariaEstagio = "Carga Horária Fixa";
        $tipoCargaDiariaEstagio = "6h";
        $dataInicioEstagio = "";
        $dataTerminoEstagio = "";
        $segundaEstagio = "";
        $tercaEstagio = "";
                            ...
                            <div class="form-row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button data-toggle="tooltip" data-placement="top" title="Data incorreta" id="tooltipDataNascimento" hidden>
                                            Data incorreta!
                                        </button>
                                    </div>
                                </div>
