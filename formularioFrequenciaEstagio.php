        ...
        <div class="row">
            <div class="col-sm-12 mt-3">
                ...
                if ($flagGlobal == 1) {
                    ...
                    Alguns dados estão faltando para que seja possível preencher o formulário de frequência de estágio.
                    <br/> <br/>
                    <?php
                    echo $alunos;
                    echo $orientador;
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 offset-md-1">
                                <form id="formFrequenciaEstagio" method="post"
                                      action="formularioFrequenciaEstagioValidar.php">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-4" id="linhaBotoes">
                                                    <button type="button" class="btn btn-success" id="botaoAdicionar">
                                                        Adicionar
                                                    </button>
                                                    <button type="button" class="btn btn-danger" id="botaoRemover">
                                                        Remover
                                                    </button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 offset-md-4" id="divCargaHorariaTotal">
                                                    <label for="CargaHorariaTotal">Carga Horária Total</label>
                                                    <input type="text" class="form-control" name="CargaHorariaTotal"
                                                           id="CargaHorariaTotal" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4 offset-md-4">
                                            <button type="submit" class="btn btn-success" id="botaoConfirmar">Salvar
                                            </button>
                                        </div>
                                    </div>
