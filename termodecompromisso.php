...
span.cls_006{font-family:Times,serif;font-size:9.1px;color:rgb(0,0,128);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_006{font-family:Times,serif;font-size:9.1px;color:rgb(0,0,128);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_007{font-family:Times,serif;font-size:9.1px;color:rgb(51,51,153);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_007{font-family:Times,serif;font-size:9.1px;color:rgb(51,51,153);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_008{font-family:Times,serif;font-size:9.1px;color:rgb(0,0,255);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_008{font-family:Times,serif;font-size:9.1px;color:rgb(0,0,255);font-weight:normal;font-style:normal;text-decoration: none}
...
span.cls_009{font-family:Times,serif;font-size:10.0px;color:rgb(0,0,128);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_009{font-family:Times,serif;font-size:10.0px;color:rgb(0,0,128);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_011{font-family:Times,serif;font-size:9.1px;color:rgb(33,33,33);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_011{font-family:Times,serif;font-size:9.1px;color:rgb(33,33,33);font-weight:normal;font-style:normal;text-decoration: none}
...
<script type="text/javascript" src="f3802a08-499d-11e9-9d71-0cc47a792c0a_id_f3802a08-499d-11e9-9d71-0cc47a792c0a_files/wz_jsgraphics.js"></script>
</head>
<body>
...
<div style="position:absolute;left:329.67px;top:231.40px" class="cls_003"><span class="cls_003">Bairro: Nova Pouso Alegre</span></div>
<div style="position:absolute;left:42.48px;top:247.00px" class="cls_003"><span class="cls_003">CEP: 37550-000</span></div>
<div style="position:absolute;left:329.63px;top:247.00px" class="cls_003"><span class="cls_003">Cidade: Pouso Alegre</span></div>
<div style="position:absolute;left:463.55px;top:247.00px" class="cls_003"><span class="cls_003">Fone: (35) 3449-6150</span></div>
<div style="position:absolute;left:42.48px;top:262.48px" class="cls_003"><span class="cls_003">Campus Poços de Caldas</span></div>
<div style="position:absolute;left:326.67px;top:262.48px" class="cls_003"><span class="cls_003">CNPJ: 10.648.539/0009-62</span></div>
...
<div style="position:absolute;left:42.48px;top:359.68px" class="cls_003"><span class="cls_003">Nome da Empresa:</span></div>
<div style="position:absolute;left:42.48px;top:375.16px" class="cls_003"><span class="cls_003">CNPJ:</span></div>
<div style="position:absolute;left:42.48px;top:390.64px" class="cls_003"><span class="cls_003">Endereço:</span></div>
<div style="position:absolute;left:247.02px;top:389.68px" class="cls_003"><span class="cls_003">Bairro:</span></div>
<div style="position:absolute;left:42.48px;top:406.24px" class="cls_003"><span class="cls_003">CEP:</span></div>
<div style="position:absolute;left:246.08px;top:406.24px" class="cls_003"><span class="cls_003">Cidade:</span></div>
<div style="position:absolute;left:359.67px;top:406.24px" class="cls_003"><span class="cls_003">Fone:</span></div>
<div style="position:absolute;left:42.48px;top:421.72px" class="cls_003"><span class="cls_003">Representada por:</span></div>
<div style="position:absolute;left:247.17px;top:421.72px" class="cls_003"><span class="cls_003">Cargo:</span></div>
<div style="position:absolute;left:42.48px;top:437.20px" class="cls_003"><span class="cls_003">Responsável pela assinatura do TCE:</span></div>
<div style="position:absolute;left:246.24px;top:437.20px" class="cls_003"><span class="cls_003">Cargo:</span></div>
<div style="position:absolute;left:42.48px;top:452.80px" class="cls_003"><span class="cls_003">Supervisor de Estágio:</span></div>
<div style="position:absolute;left:245.73px;top:451.84px" class="cls_003"><span class="cls_003">Cargo:</span></div>
<div style="position:absolute;left:255.72px;top:483.76px" class="cls_005"><span class="cls_005">ESTAGIÁRIO(A)</span></div>
<div style="position:absolute;left:42.48px;top:502.84px" class="cls_003"><span class="cls_003">Nome:</span></div>
<div style="position:absolute;left:42.48px;top:518.32px" class="cls_003"><span class="cls_003">Endereço:</span></div>
<div style="position:absolute;left:241.15px;top:518.32px" class="cls_003"><span class="cls_003">Bairro:</span></div>
<div style="position:absolute;left:42.48px;top:533.80px" class="cls_003"><span class="cls_003">CEP:</span></div>
<div style="position:absolute;left:241.08px;top:533.80px" class="cls_003"><span class="cls_003">Cidade:</span></div>
<div style="position:absolute;left:357.28px;top:533.80px" class="cls_003"><span class="cls_003">Fone:</span></div>
<div style="position:absolute;left:42.48px;top:549.40px" class="cls_003"><span class="cls_003">Regularmente Matriculado no Curso _________________________________</span></div>
<div style="position:absolute;left:42.48px;top:564.88px" class="cls_003"><span class="cls_003">CPF:</span></div>
<div style="position:absolute;left:355.55px;top:564.88px" class="cls_003"><span class="cls_003">RG:</span></div>
<div style="position:absolute;left:42.48px;top:580.36px" class="cls_003"><span class="cls_003">Data de Nascimento:</span></div>
<div style="position:absolute;left:356.65px;top:580.36px" class="cls_003"><span class="cls_003">E-mail:</span></div>
...
<div style="position:absolute;left:78.48px;top:762.04px" class="cls_003"><span class="cls_003">______________________ (dias da semana), das ________ às _________ horas, totalizando _____________</span></div>
<div style="position:absolute;left:78.48px;top:771.40px" class="cls_003"><span class="cls_003">horas por dia, ______________ horas por semana e _________________________ horas de estágio obrigatório.</span></div>
...
<div style="position:absolute;left:78.46px;top:93.40px" class="cls_003"><span class="cls_003">Pelo trancamento da matrícula, abandono, desligamento ou conclusão do curso na INSTITUIÇÃO DE ENSINO;</span></div>
<div style="position:absolute;left:60.48px;top:103.72px" class="cls_003"><span class="cls_003">g)</span></div>
<div style="position:absolute;left:78.45px;top:103.72px" class="cls_003"><span class="cls_003">Pelo descumprimento das condições do presente Termo de Compromisso de Estágio;</span></div>
...
<div style="position:absolute;left:380.15px;top:259.00px" class="cls_006"><span class="cls_006">-</span><span class="cls_003">   No   desenvolvimento   do   estágio   ora</span></div>
...
<div style="position:absolute;left:181.20px;top:322.00px" class="cls_011"><span class="cls_011">______________________, _____________________ (cargo)</span><span class="cls_003">, para ser o supervisor de</span></div>
...
<div style="position:absolute;left:60.48px;top:518.56px" class="cls_002"><span class="cls_002">a) </span><span class="cls_003">  Designar o (a) Sr. (a) _______________________________ para ser o(a) Professor(a) Orientador(a) responsável</span></div>
